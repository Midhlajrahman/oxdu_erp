...
class HybridDetailView(AcademicYearBranchSessionMixin, LoginRequiredMixin, DetailView):
...
class HybridCreateView(AcademicYearBranchSessionMixin, LoginRequiredMixin, CustomModelFormMixin, SuccessMessageMixin, CreateView):
...
class HybridUpdateView(AcademicYearBranchSessionMixin, LoginRequiredMixin, CustomModelFormMixin, SuccessMessageMixin, UpdateView):
    exclude = ("creator","branch")
    template_name = "app/common/object_form.html"
    inline_formset = None
...
class HybridDeleteView(AcademicYearBranchSessionMixin, LoginRequiredMixin, DeleteView):
...
class HybridListView(AcademicYearBranchSessionMixin, LoginRequiredMixin, ExportMixin, SingleTableMixin, FilterView, ListView):
...
class HybridFormView(AcademicYearBranchSessionMixin, LoginRequiredMixin, FormView):
    pass


class HybridTemplateView(AcademicYearBranchSessionMixin, LoginRequiredMixin, TemplateView):
    template_name = "app/common/object_view.html"


class HybridView(AcademicYearBranchSessionMixin, LoginRequiredMixin, View):
    pass
